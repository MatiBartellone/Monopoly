...
public class CasillaArribaView extends CasillaView {
    public CasillaArribaView(Casilla casilla, List<Jugador> jugadores) {
    ...
    protected Node getCasillaView(VBox jugadores, Label info){
        VBox cView = new VBox(jugadores, info);
        cView.setAlignment(Pos.BOTTOM_CENTER);
